...
var async, fs, hljs, marked, md2craftml, parseMarkdownSync, path, resolveLink, url, yaml,
...
resolveLink = function(content, uri, baseUrl) {
   ...
   */
  var nav, part, uriParts, _ref;
  uriParts = url.parse(uri);
  if (uriParts.protocol) {
    return uri;
  } else {
    nav = content.parent;
    path = ((_ref = uriParts.pathname) != null ? _ref.split('/') : void 0) || [];
